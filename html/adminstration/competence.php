  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm">
            <h1 class="text-center " style="margin-top: 20px">Compétences</h1>
          </div>
        </div>

        <?php foreach($data_comp as $comp) { ?>
        <div class="container" style="margin-top: 6%">
          <form action="modifcom.php" method="post">
            <div class="row justify-content-md-center">
              <div class="col-lg-2">
                <label for="new_titre">Titre:</label>
                <textarea class="form-control" name="new_titre" id="new_titre" rows="8"><?=$comp["comp_titre"];?></textarea>
              </div>
              <div class="col-lg-3">
                <label for="new_idk">Image:</label>
                <img src="../img/<?=$comp["comp_img"];?>" class="img-fluid">
              </div>

              <div class="col-lg-3">
                <label for="new_img">Image:</label>
                <textarea class="form-control" name="new_img" id="new_img" rows="8"><?=$comp["comp_img"];?></textarea>
              </div>

              <div class="col-lg-4">
                <label for="new_texte" >Texte:</label>
                <textarea class="form-control" name="new_texte" id="new_texte" rows="8"><?=$comp["comp_txt"];?></textarea>
              </div>
            </div>
            <div class="row justify-content-md-center">
                <input type="hidden" name="comp_id" id="comp_id" value="<?=$comp["comp_id"];?>">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm">
            <h2 class="text-center " style="margin-top: 20px">Nouvelle compétences</h2>
          </div>
        </div>
        <form action="newcompetence.php" method="post" style="width: 100%">
          ...
          <button class="btn btn-primary col-sm" type="submit" style='margin-top: 3%; margin-bottom: 3%'>CREATION NEW COMPETENCE</button>
        </form>
        <div class="row justify-content-md-center">
          <form action="uploadcompetence.php" method="post" enctype="multipart/form-data" style='margin-top: 3%; margin-bottom: 3%'>
